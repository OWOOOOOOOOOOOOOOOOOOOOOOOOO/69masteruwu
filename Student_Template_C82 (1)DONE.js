console.log("My first console project");
            ...
            var first_name = "Nivin";
            var last_name = "Karthick";
...
*/
            ...
            var previous_a = Math.random(1,10); 
            var previous_b = Math.random(1,10);
            var a = Math.round(previous_a);
            var b = Math.round(previous_b);
/*
